...
Entry.create!(:title => "Hello...", :content => "Welcome to DearDiary")
...
Entry.create!(:title => "I got a new puppy dog", :content => "I got a new puppy I will name him Browser. He is cute.");
